...
def song(_, message):
    ...
    try:
        ...
        m.edit("❌ لم أجد الأغنية.\n\nرجاء أعطني اسم صحيح .")
        print(str(e))
        return
    m.edit("📥 يتم تحميل الأغنية...")
    try:
        ...
        m.edit("❌ حدث خطأ انتظر مالك البوت حتي يصلحه")
        print(e)
...
@Client.on_message(
    command(["تحميل_فيديو", f"vsong@{bn}", "video", f"video@{bn}"]) & ~filters.edited
)
