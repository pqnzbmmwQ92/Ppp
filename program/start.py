...
@Client.on_message(command(["EITHON"]) & filters.private & ~filters.edited)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "↬ Ξ𝗜𝗧𝗛𝗢𝗡™ ⟊", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
            ]
        ),
...
@Client.on_message(
    command([".", f"alive@{BOT_USERNAME}"]) & ~filters.edited
)
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("✨ كروب الدعم", url=f"https://t.me/eithonsupport"),
                InlineKeyboardButton(
                    "↬ Ξ𝗜𝗧𝗛𝗢𝗡™ ⟊", url=f"https://t.me/{UPDATES_CHANNEL}"
                ),
            ]
