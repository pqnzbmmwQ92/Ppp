...
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, BOT_TOKEN, UPDATES_CHANNEL
...
@Client.on_message(command(["تشغيل", "شغل", f"play@{BOT_USERNAME}"]) & other_filters)
